    ...
    setup(
        ...
        ext_modules=[
            make_cuda_ext(
                ...
                module="mmdet3d_plugin.ops.tile_localagg_prob_sq",
                sources=[
            ...
            make_cuda_ext(
                name="local_aggregate_prob_sq._C",
                module="mmdet3d_plugin.ops.localagg_prob_sq",
                sources=[
                    "src/aggregator_impl.cu",
                    "src/forward.cu",
                    "src/backward.cu",
            ...
            make_cuda_ext(
                ...
                module="mmdet3d_plugin.ops.msmv_sampling",
                sources=[
